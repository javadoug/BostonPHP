...
if ($mysqli->query(query)) { then success } else { an error }
$mysqli->error

INSERT query returns new id value
...
$val = $mysqli->real_escape_string('text to use in sql');
...
?>
<h1>Register</h1>
<form action="16.02-register.php" method="post">
